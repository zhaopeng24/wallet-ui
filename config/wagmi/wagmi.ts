...
import { hardhat, polygon, polygonMumbai, avalanche, avalancheFuji, moonbaseAlpha } from 'wagmi/chains'
import { publicProvider } from 'wagmi/providers/public'
import { alchemyProvider } from 'wagmi/providers/alchemy'
import { jsonRpcProvider } from 'wagmi/providers/jsonRpc'
import { AVALANCHE_HTTP_RPC, AVALANCHEFUJI_HTTP_RPC, MOONBASE_HTTP_RPC } from '@/constants/constants'
...
const { chains, publicClient, webSocketPublicClient } = configureChains(
  [
    ...
    ...(process.env.NEXT_PUBLIC_ENABLE_TESTNETS ? [polygonMumbai, avalancheFuji, moonbaseAlpha] : []),
  ],
  [
...
const wagmiConfig = createConfig({ publicClient, webSocketPublicClient, autoConnect: true })
