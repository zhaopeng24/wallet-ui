...
const Register = () => {
  ...
  const signUp = async () => {
    ...
    const save2IPFS = await mpc.saveKey2DecentralizeStorage(key3, Global.tempLocalPassword);
    ...
    const save2Server = await mpc.saveKey2WalletServer(key2, save2IPFS.body["result"]['result'])
  ...
  return (
    <div className='h-full bg-[url(/imgs/bg.png)]'>
      ...
      <div className='mian p-8'>
        ...
        <PasswordInput passwordType='comfirm' firstPassword={password} value={surePassword} onValueChange={setSurePasswork} className='mb-6' label="Confirm Password" />
        <EmailInput
          value={email}
